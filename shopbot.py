...
bot = "5043500003:AAEIDoe2O8-xDaEX4MJnp9HZs9pUD8NnqEM"
api_id = 13279560
...
admin_id = 785522876   #USER ID ACCOUNT TELEGRAM PER UTILIZZARE I COMANDI ADMIN DEL BOT
        ...
        try:
            ...
            try:
                if(text[0] == "/start"):
                    ...
                    await client.send_message(int(referralid), "<b>AVVISO</b> 🎉\nℹ️ Caro utente, ti informiamo che un utente ha avviato il bot tramite il tuo link Referral, il tuo credito attuale è stato aggiornato con +0,03 EUR.",
                        buttons=[[Button.inline("✅ ACCETTA ✅", "home")]])
...
async def callbackQuery(e):
    ...
    if(e.data == b"home"):
        ...
        await e.edit("👇Scegli con quale metodo di pagamento vuoi ricaricare il tuo saldo!",
                buttons=[[Button.inline("💰PayPal", "paypal"), Button.inline("💳Bitcoin", "bitcoin")],
                [Button.inline("⬅️ INDIETRO", "home")]]),  
